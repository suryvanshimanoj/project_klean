        ...
        <div id="header-carousel" className="carousel slide carousel-fade" data-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img className="img-fluid" src="website/img/carousel-1.jpg" alt="Image" />
            ...
            <div className="carousel-item">
              <img className="img-fluid" src="website/img/carousel-2.jpg" alt="Image" />
              <div className="carousel-caption d-flex align-items-center justify-content-center">
                <div className="p-5" style={{ width: '100%', maxWidth: 900 }}>
                  <h5 className="text-primary text-uppercase mb-md-3">Cleaning Services</h5>
            ...
            <div className="carousel-item">
              <img className="img-fluid" src="website/img/carousel-3.jpg" alt="Image" />
              <div className="carousel-caption d-flex align-items-center justify-content-center">
                <div className="p-5" style={{ width: '100%', maxWidth: 900 }}>
                  <h5 className="text-primary text-uppercase mb-md-3">Cleaning Services</h5>
